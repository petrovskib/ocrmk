...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'                => __('Construction Solutions Homepage','cdi'),
            'categories'                      =>  array( 'Free' , 'Homepage' ),
            'local_import_file'               => CDI_PLUGIN_DIR_PATH . '/themes/construction-solutions/inc/content.xml',
            'local_import_customizer_file'    => CDI_PLUGIN_DIR_PATH . '/themes/construction-solutions/inc/options.dat',
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Construction Solutions Homepage':
            $front_page_id = get_page_by_title( 'Construction Solutions Homepage' );
            break;
