...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'             => __('Learn Education Business Free','cdi'),
            'categories'                   =>  array( 'Free' , 'Homepage' ),
            'local_import_file'            => CDI_PLUGIN_DIR_PATH . '/themes/learn-education-business/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/learn-education-business/inc/options.dat',
            'import_preview_image_url'     => CDI_PLUGIN_DIR_URL . '/assets/images/education-business/homepage-pro-7.jpg',
            'preview_url'                  => 'https://bizbergthemes.com/education-business-pro/homepage-7/'
        ),
        array(
            'import_file_name'=> __('Education Empowerment PRO','cdi'),
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Learn Education Business Free':
             $front_page_id = get_page_by_title( 'Learn Education Business' );
            break;
